...
class _Vertex:
    ...
    def __init__(self, item: Any, kind: str) -> None:
        ...
        Preconditions:
            - kind in {'actor', 'movie'}
            - self.appearance = set() or kind = 'actor'
...
class Graph:
    ...
    def add_appearance(self, actor: str, movie: str) -> None:
        ...
        if actor in self._vertices:
            self._vertices[actor].appearance.add(movie)
        else:
            raise ValueError
    ...
    def get_common_movies(self, item1: str, item2: str) -> set:
        ...
        >>> g.add_appearance('actor1','movie1')
        >>> g.add_appearance('actor1','movie2')
        ...
        if item1 in self._vertices and item2 in self._vertices:
            v1 = self._vertices[item1]
            v2 = self._vertices[item2]
            return v1.appearance.intersection(v2.appearance)
        else:
            raise ValueError
...
#############################
    ...
    def shortest_path_bfs_filtered(self, starting_item: str, target_item: str, key: str,
        ...
        while queue:
            ...
            # Traverse only through valid movies
    ...
    def filter_by_key(self, actor1: str, actor2: str, key: str,
        ...
        if actor1 in self._vertices and actor2 in self._vertices:
            ...
            if key == 'year':
                common = v1.appearance.intersection(v2.appearance)
